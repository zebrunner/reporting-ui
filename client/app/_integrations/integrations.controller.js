...
const integrationsController = function integrationsController($state, $mdDialog, SettingsService, toolsService, windowWidthService, messageService, integrationsService, $transitions, pageTitleService) {
    'ngInject';
