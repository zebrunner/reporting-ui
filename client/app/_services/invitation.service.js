(function() {
    ...
    function InvitationService($httpMock, $rootScope, $state, $httpParamSerializer, UtilService, UserService) {
        ...
        function invite(invitations) {
            ...
            return $httpMock.post(`${$httpMock.serviceUrl}/api/iam/v1/invitations`, invitations.invitationTypes, {headers: {'Authorization':`${authData.authTokenType} ${authData.authToken}`}})
